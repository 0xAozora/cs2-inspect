...
func file_cstrike15_usermessages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cstrike15_usermessages_proto_msgTypes[71].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CCSUsrMsg_CounterStrafe); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cstrike15_usermessages_proto_msgTypes[72].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CCSUsrMsg_DamagePrediction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cstrike15_usermessages_proto_msgTypes[87].Exporter = func(v interface{}, i int) interface{} {
